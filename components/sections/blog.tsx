      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {blogPosts.map((post, i) => (
            <AnimateOnScroll key={post.link ?? post.title} delay={i * 80}>
              ...
              {post.link ? (
                <a
                  ...
                  className="block"
                >
                  <article className="group flex h-full flex-col rounded-xl border border-border bg-card p-6 transition-all hover:border-primary/30 hover:-translate-y-1">
                ...
                <article className="group flex h-full flex-col rounded-xl border border-border bg-card p-6">
